...
Не используй внешние знания о бизнесе. Основывайся только на описании компании, сообщении, контексте диалога и примерах из истории, если они указаны.
...
- Если сообщение явно относится к другой сфере, другой нише или другой услуге, чем описание компании, всегда выбирай lead=false.
- Текущая ниша оценивается отдельно от других ниш. Не подменяй услуги текущей ниши услугами из других ниш.
...
Поле lead — boolean.
Поле description — строка на русском языке, максимум 180 символов.
