...
Ниша, услуги, целевая аудитория, ограничения и важный контекст описаны ниже.
Работай согласно описанию компании, ключевым фразам, памяти и смыслу сообщения.
...
- его должен соответствовать услугам или продуктам компании
...
{{
  "lead": true или false,
  "description": "Объясни, почему сообщение является или не является лидом, опираясь на описание ниши, ключевые фразы, правила и примеры из памяти"
}}
